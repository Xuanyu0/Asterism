...
export function bootstrapDevTools(): void {
    ...
    const GOLDEN_ID = graphStore.createRootGraph('金牌测试图', { id: 'graph-golden' as GraphId })
    ...
    const SILVER_ID = graphStore.createRootGraph('银牌测试图', { id: 'graph-silver' as GraphId })
