...
describe('moveNode', () => {
    it('无碰撞通过', () => {
        ...
        const result = moveNode({ nodeId: 'a' as NodeId, desiredPosition: { x: 100, y: 100 }, allNodes: graph.nodes, nodeRadiusOverrides: R })
    ...
    it('碰撞返回 error', () => {
        ...
        // a 要移到 b 的位置 → 碰撞
        const result = moveNode({ nodeId: 'a' as NodeId, desiredPosition: { x: 50, y: 0 }, allNodes: graph.nodes, nodeRadiusOverrides: R })
