...
describe('createReversal update_edge', () => {
    test('逆操作 update_edge 恢复旧值', () => {
        ...
        const op = {
            ...
            edge: { ...graph.edges[0]!, label: 'changed' },
        }
        assertReversalRoundTrip(graph, op)
    })
})
            ...
            foldedDependencies: [
                {
                    ...
                    foldedNodeIds: ['n1' as NodeId, 'n2' as NodeId],
                },
            ],
        }
        const op = {
