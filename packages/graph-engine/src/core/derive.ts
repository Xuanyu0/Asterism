...
export const deriveAbstractionLevel: DeriveAbstractionLevel = (
    lookupGraph,
    node,
) => deriveLevel(node, lookupGraph, new Set<GraphId>())

/**
 * 沿 childGraphId 链递归推导 abstractionLevel 的私有实现。
 *
 * @param current - 当前节点
